...
BT = BalancingTree(5) # 2**5-2 までの数を扱える

for i in range(10):
    BT.append(i) # 要素を挿れる

BT.delete(11) # なかったら何も起こらない
BT.debug() # 入ってる数の状態を表示
lst = BT.debug_list() # 要素をリストにして表示

print(BT.find_l(6)) # 要素より小さい最大の数
print(BT.find_r(-1)) # 要素より大きい最小の数
print(BT.min) # 木の中で最小の数
print(BT.max) # 木の中で最大の数
print(3 in BT) # True
print(-1 in BT) # False
